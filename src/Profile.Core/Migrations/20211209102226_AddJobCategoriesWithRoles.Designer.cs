...
namespace Profile.Core.Migrations
{
    ...
    [Migration("20211209102226_AddJobCategoriesWithRoles")]
    partial class AddJobCategoriesWithRoles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Profile.Core.UserPreferences.JobCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Profile.Core.UserPreferences.JobRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Profile.Core.UserPreferences.UserExtraPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Profile.Core.UserPreferences.JobRole", b =>
                {
                    b.HasOne("Profile.Core.UserPreferences.JobCategory", "JobCategory")
                        .WithMany("JobRoles")
